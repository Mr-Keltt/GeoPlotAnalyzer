namespace GeoPlotAnalyzer.API.Configuration
{
    using Microsoft.AspNetCore.Diagnostics.HealthChecks;
    using GeoPlotAnalyzer.Common.HealthCheck;
    using Microsoft.AspNetCore.Builder;
    using Microsoft.Extensions.DependencyInjection;

    /// <summary>
    /// Provides extension methods for configuring health checks within the GeoPlotAnalyzer application.
    /// </summary>
    public static class HealthCheckConfiguration
    {
        ...
        public static IServiceCollection AddAppHealthChecks(this IServiceCollection services)
        {
            ...
            services.AddHealthChecks()
                .AddCheck<SelfHealthCheck>("GeoPlotAnalyzer.API");
